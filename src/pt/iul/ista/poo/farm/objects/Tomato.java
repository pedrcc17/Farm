 ...
 * @author PedroCosta
 * 
 *         Representa a informacao associada e implementa o ciclo de vida de um
 *         tomate
 *
 *
 */
...
public class Tomato extends Vegetable {
	...
	private int cyclesAfterTakenCare; // contador de ciclos desde que foi
										// cuidado a ultima vez
	...
	/**
	 * Por cada ciclo de jogo, irá incrementar em 1, o numero de ciclos desde
	 * que foi cuidado.
	 * 
	 * Apenas ira amadurecer caso tenha sido cuidado a menos de 10 ciclos
	 * 
	 * Ira apodrecer independentemente de ter ou nao sido cuidado (podendo
	 * apodrecer sem amadurecer primeiro)
	 * 
	 */
	@Override
	 ...
	 * 
	 * Caso nao seja preciso remover, cuida do tomate (pondo a 0 o contador de
	 * ciclos desde que foi cuidado)
	 */
	@Override
	...
	public String toString() {
		return "Tomato " + getPosition().getX() + ";" + getPosition().getY() + " " + getCyclesToRipe() + " "
				+ getCyclesToRot() + " " + cyclesAfterTakenCare;
	}
